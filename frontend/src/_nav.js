...
const _nav = [
  {
    category: translate("UI.USERS"),
    items: [
      {
        name: translate("MENU.USER_MANAGEMENT"),
        icon: <MdOutlineAccountCircle />,
        label: "user",
        items: [
          {
            name: translate("UI.USERS"),
            url: "dashboard/user",
          },
          {
          ...
          {
            name: translate("MENU.COMMUNICATION_AGENT"),
            url: "dashboard/sales-commission-agents",
          },
        ],
      },
    ],
