...
export default function Modals() {
    ...
    const displayOnClose = state.onClose ? { onClose: () => setState({ width: '', scrollBehavior: '', open: false, onClose: false }) } : {};
    ...
    return (
        <AppPage title="Modals">
                ...
                <TabContent>
                    <div className="mt-3">
                        <ComponentInfo title='Default'>
                            ...
                            <Preview>
                                <Button onClick={() => setState({...state, open: !state.open, onClose: true})} appearance="primary">Open modal</Button>
                            </Preview>
                    ...
                    <div className="mt-3">
                        <ComponentInfo title='Scrolling behavior'>
                            ...
                            <Preview>
                                <ButtonGroup appearance="primary">
                                    <Button onClick={() => setState({open: true, width: 'medium', scrollBehavior: 'inside'})}>Scroll inside</Button>
                                    <Button onClick={() => setState({open: true, width: 'medium', scrollBehavior: 'outside'})}>Scroll outside</Button>
                                </ButtonGroup>
                            </Preview>
            ...
            >
                ...
                <ModalBody>
                    {!state.scrollBehavior ? <p>In the serene twilight, whispers of forgotten dreams linger, embracing the essence of a world painted in hues of endless possibilities.</p> 
                    : <div>
                        <div className="w-100">
                            <Input 
                                label='Text Input'
                ...
                <ModalFooter>
                        <Button appearance="soft" onClick={() => setState({width: '', scrollBehavior: '', open: false})}>Cancel</Button>
                        <Button appearance="primary" onClick={() => setState({width: '', scrollBehavior: '', open: false})}>Confirm</Button>
                </ModalFooter>
            </Modal>
        </AppPage>
    );
