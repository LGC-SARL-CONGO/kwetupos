...
export default function CreateProduct() {
    ...
    return <AppPage title={translate('ECOMMERCE.ADD_PRODUCT')}>
        <CardContainer title={translate('ECOMMERCE.PRODUCT_INFORMATION')}>
            <Container className='p-3'>
                ...
                <ContainerItem sm={4} md={4} xl={3}>
                    <Input 
                        label={translate('ECOMMERCE.BRAND')}
                        type='text'
                        required
                    />
                </ContainerItem>
                ...
                <ContainerItem sm={4} md={4} xl={3}>
                    <Input 
                        label={translate('ECOMMERCE.MODEL')}
                        type='text'
                        required
                    />
                </ContainerItem>
                ...
                <ContainerItem sm={4} md={4} xl={3}>
                    <Input 
                        label={translate('ECOMMERCE.WEIGHT')}
                        type='text'
                        required
                    />
                </ContainerItem>
                ...
                <ContainerItem sm={4} md={8} xl={12}>
                   ...
                   <RichTextEditor useBorder placeholder={translate('ECOMMERCE.PRODUCT_DESCRIPTION')} focused/>
                </ContainerItem>
            </Container>
        </CardContainer>
        ...
        <CardContainer title={translate('ECOMMERCE.TECHNICAL_SPECIFICATIONS')}>
           {options}
            ...
            <div className='p-3'>
                <Button onClick={addOption} appearance='primary'>{translate('ECOMMERCE.ADD_ANOTHER_LINE')}</Button>
            </div>
