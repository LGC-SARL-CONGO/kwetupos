...
export default function ReadEmail({ info, onBack, screenSize }) {
    const actionOptions = [
            ...
            <CardContainer className={styles["email__details"]}>
                <div className={styles["actions__detail"]}>
                    <div className="d-flex align-items-center gap-1">
                        ...
                        <div className={styles["subject__detail"]}>
                            {info?.subject}
                        </div>
                    </div>
                    ...
                    <>
                        <div className="d-flex align-items-center justify-content-between w-100 mb-3">
                            ...
                            <span className="d-flex u-pointer">
                                <Tooltip 
                                    position='left'
                                    content={translate(
                                        "EMAIL.DOWNLOAD_ALL_ATTACHMENTS"
                                    )}
                                >
                        ...
                        <div className={styles["message__attachments"]}>
                            {info?.attachments?.map((attachment, index) => (
                                <div
                                    key={index}
                                    className={`styles['attachment__list']`}
                                >
                                    <MediaPreview
                                        file={attachment}
                                        displayFooter={true}
