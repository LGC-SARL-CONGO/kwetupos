...
export default function DropdownMenu({ options, onClicked, direction }) {
    ...
    return (
        ...
        >
            <div
                className={styles["dropdown-menu-container__header"]}
            ...
            <div
                className={`${styles["dropdown-menu-container__content"]} ${dropdownOpen && styles['dropdown-menu-container__content--visible']} ${direction === "top" && styles["dropdown-menu-container__content--reverse"]}`}
            ...
            >
                <ul ref={childRef}>
                    {options?.map((option, index) => (
                        ...
                        >
                            {option.icon && <span className={`${styles['dropdown-menu-container__content__item--icon']}`}>{option.icon}</span>}
