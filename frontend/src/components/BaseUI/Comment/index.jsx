    ...
    return <div className={styles['comment-container']}>
        ...
        <div className={styles['comment-container__comment']}>
            <div className={styles['comment-container__comment__header']}>
                <span className={styles['comment-container__comment__header--author']}>{author}</span>
                <span className={styles['comment-container__comment__header--time']}>{formatDate(time)}</span>
            </div>
...
export const CommentAction = ({ children }) => {
    return <span className={styles['comment-container__comment__actions--action']}>{children}</span>
}