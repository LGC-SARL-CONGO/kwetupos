...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
    ...
    Route::get('/contacts/all-customers', [ContactController::class, 'getAllCustomers']);
...
// Routes pour le CustomerSupportController
Route::get('/contact', [CustomerSupportController::class, 'showForm'])->name('contact.form');
Route::post('/contact', [CustomerSupportController::class, 'sendContactForm'])->name('contact.send');

Route::post('/chat/store', [ChatBotController::class, 'store']);
Route::get('/chat/history', [ChatBotController::class, 'index'])->middleware('auth');
Route::get('/chat/check-last-interaction', [ChatBotController::class, 'checkLastInteraction']);
Route::post('/chat/call', [ChatBotController::class, 'handleCall']);
Route::post('/chat/get-response', [ChatBotController::class, 'getResponse']);