LANG = {
    ...
    paid_amount_is_more_than_payable:
        'Paid amount is more than the payable amount. \nPlease check.',
    ...
    confirm_delete_expense_category:
        'This category along with all expenses under this category will be deleted.',
    ...
    confirm_delete_category:
        'This category along with all sub-categories under it will be deleted.',
    ...
    tour_step2_content:
        'Here you can find your shop related information, Basic information, Product SKU, Discounts, Taxes & other settings.',
    ...
    tour_step7_content:
        'Sell -> POS, Use this screen while selling products or billing customer. Select Location, Add Products and Finalize it.',
    tour_step8_title: 'Step7: Reports',
    tour_step8_content:
        'View analytic reports for your shop. These reports help you get overall information about the performance of your business.',
    ...
    tour_step3_content_modified:
        'Add Multiple Locations, Tax Rates, Invoice Settings for your shop.',
    tour_step5_content_modified:
        'Add Products - Simple or Variable Products <br> Create Variations for variable products <br> Create Units, Brands and Categories <br> Print labels',
