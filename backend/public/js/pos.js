...
$(document).ready(function () {
    ...
    $('select#customer_id').select2({
        ...
        minimumInputLength: 0, // Charger les données des clients dès l'ouverture du menu déroulant
        minimumResultsForSearch: 5, // Cacher la barre de recherche si le nombre de résultats est inférieur à 5
        language: {
            ...
            noResults: function () {
                ...
                return (
                    '<p>' +
                    __translate('no_results_found', { name: name }) +
                    '</p>' +
                    '<p>' +
                    __translate('or_add_as_new_customer', { name: name }) +
                    '</p>'
                );
            },
        },
