    ...
    public function store(Request $request)
{
    ...
    try {
        ...
        dump($role_name, $permissions, $business_id, $count); // Afficher les données dans la console

        // Vous pouvez aussi utiliser dd() pour arrêter l'exécution ici et afficher les valeurs
        // dd($role_name, $permissions, $business_id, $count);
