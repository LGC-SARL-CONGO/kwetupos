    ...
    <div class="tw-px-5 tw-py-3">
        <div class="tw-flex tw-items-start tw-justify-between tw-gap-6 lg:tw-items-center">
            ...
            <div class="tw-flex tw-flex-wrap tw-items-center tw-justify-end tw-gap-3">
                ...
                <button onclick="goBack()" title="{{ __('lang_v1.go_back') }}"
                    class="tw-text-white hover:tw-text-white tw-transition-all tw-duration-200 tw-bg-@if(!empty(session('business.theme_color'))){{session('business.theme_color')}}@else{{'primary'}}@endif-800 hover:tw-bg-@if(!empty(session('business.theme_color'))){{session('business.theme_color')}}@else{{'primary'}}@endif-700 tw-cursor-pointer tw-ring-1 tw-ring-white/10 tw-flex tw-items-center tw-justify-center tw-rounded-md md:tw-w-8 tw-w-auto tw-h-8 pull-right">
                    <strong class="!tw-m-3">
                        <i class="fa fa-backward fa-lg fa fa-backward tw-fa-lg tw-text-[#fff] !tw-text-sm"></i>
                    </strong>
                </button>
                ...
                <details class="tw-dw-dropdown tw-relative tw-inline-block tw-text-left">
                    ...
                    <div class="tw-dw-menu tw-dw-dropdown-content tw-dw-z-[1] tw-dw-bg-base-100 tw-dw-rounded-box tw-w-48 tw-absolute tw-left-0 tw-z-10 tw-mt-2 tw-origin-top-right tw-bg-white tw-rounded-lg tw-shadow-lg tw-ring-1 tw-ring-gray-200 focus:tw-outline-none">
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        const dropdowns = document.querySelectorAll('.tw-dw-dropdown');
        ...
        // Ferme les dropdowns en cliquant en dehors
