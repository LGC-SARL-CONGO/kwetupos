            ...
            <div
                ...
                <div class="tw-flex tw-flex-col tw-gap-4 tw-dw-rounded-box tw-dw-p-6 tw-dw-max-w-md">
                    ...
                    <form method="POST" action="{{ route('login') }}" id="login-form">
                                ...
                                <div class="tw-dw-label">
                                    ...
                                    @if (config('app.env') != 'demo')
                                        <a href="{{ route('password.request') }}"
                                            class="tw-text-xs md:tw-text-sm tw-font-medium tw-bg-gradient-to-r tw-inline-block tw-text-transparent tw-bg-clip-text hover:text-[#7c1c1c]"
                                            style="color: #db221a"
                        ...
                        <button type="submit"
                        class="tw-h-12 tw-rounded-xl tw-text-sm md:tw-text-base tw-text-white tw-font-semibold tw-w-full tw-max-w-full mt-2 red-gradient focus:tw-outline-none focus:tw-ring-2 focus:tw-ring-red-500 focus:tw-ring-offset-2">
                        @lang('lang_v1.login')
                    </button>
                    </form>
