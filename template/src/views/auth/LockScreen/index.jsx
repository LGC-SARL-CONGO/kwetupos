...
export default function LockScreen() {
    ...
    return <div className={styles['lock-screen-container']}>
        <Content title={translate('AUTHENTICATION.LOCK_SCREEN')}>
            <div className='d-flex flex-column align-items-center w-100 mt-3'>
                ...
                <span className='weight-500 size-15 mt-3'>{translate('AUTHENTICATION.HI')}, Beatriz</span>
            </div>

            <p className={styles['message']}>{translate('AUTHENTICATION.ENTER_YOUR_PASSWORD_TO_LOG_IN_AGAIN')}</p>
            ...
            <div className={styles['register']}>
                ...
                <span className={styles['create__account']} onClick={() => navigate('/login')}>{translate('AUTHENTICATION.TO_ENTER')}</span>
            </div>
        </Content>
    </div>
}