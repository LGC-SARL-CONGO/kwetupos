...
export default function Sellers() {
    ...
    return (
        <AppPage
            ...
            actions={<Button appearance="primary" onClick={() => setAddSeller(true)}>{translate('ECOMMERCE.ADD_SELLER')}</Button>}
        >
            <Container>
                ...
                <ModalBody>
                    ...
                    <div className="d-flex align-items-start gap-1 mb-3">
                        ...
                        <div>
                            ...
                            {sellerDetail?.neighborhood}, {sellerDetail?.number}
                            , {sellerDetail?.city}/{sellerDetail?.state} -{" "}
                    ...
                    <div className="d-flex align-items-center gap-1 mb-3">
                        <div className="weight-500">
                            {translate("UI.ASSESSMENT")}:
                        </div>
                        <div className="d-flex align-items-center">
                            <div className="material-symbols-outlined size-20">
                                star
                            </div>
                            <div className="size-14 pl-1">
                                {sellerDetail?.ratingAverage}
                            </div>
                        </div>
                    </div>
                </ModalBody>
            ...
            <Modal isOpen={addSeller} alignment={"center"} size={"medium"} onClose={() => setAddSeller(false)}>
