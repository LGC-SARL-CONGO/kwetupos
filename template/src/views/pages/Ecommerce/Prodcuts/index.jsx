...
const Products = () => {
    ...
    return (
        <AppPage 
            ...
            actions={<Button appearance="primary" onClick={() => navigate('/dashboard/ecommerce/products/create')}>{translate('ECOMMERCE.ADD_PRODUCT')}</Button>}
        >
            <Container>
                    ...
                    >
                        {products.map((product, index) => (
                            <Tr key={index} id={product?.id}>
                                ...
                                <Td>
                                    <Lozenge appearance={product.status === 1 ? 'success-subtle' : 'danger-subtle'}>
            ...
            <SidebarContainer show={sidebarOpened} title='Edição de produto' onClose={closeSidebar}>
                <Input type={'text'} value={productInfo?.name} label={translate('UI.NAME')}/>
                ...
                <Input type={'number'} value={productInfo?.price} label={translate('UI.PRICE')}/>

                <Input type={'number'} value={productInfo?.['stock']} label={translate('UI.STOCK')}/>
