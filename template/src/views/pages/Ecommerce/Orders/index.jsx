...
const Orders = () => {
    ...
    return (
        <AppPage
            title={translate("ECOMMERCE.ORDERS")}
        ...
        >
                    ...
                    >
                        {orders.map((order, index) => (
                            <Tr key={index}>
                                ...
                                <Td>
                                    <Lozenge appearance={paymentStatus[order.paymentStatus].class}>
            ...
            <Modal isOpen={openModal} alignment={"center"} size={"medium"} onClose={handleCloseModal}>
                <ModalHeader>
                    {translate("ECOMMERCE.ORDER_DETAILS")}
                </ModalHeader>
                <ModalBody>
                    ...
                    <div className="d-flex align-items-center gap-1 mb-3">
                        ...
                        <div className="d-flex align-items-center gap-1">
                            <div>
                                {orderDetail?.paymentMethod === 1 ? "1" : "4"} x{" "}
                            </div>
                            <div>
                                <Lozenge appearance='info-subtle'>
                                    ...
                                    <div>
                                        {paymentMethod[orderDetail?.paymentMethod]?.name}
                                    </div>
                                </Lozenge>
                            </div>
                        </div>
                    ...
                    <ListGroup borderless={true}>
                        ...
                        <ListItem>
                            ...
                            <div>
                                {format(orderDetail?.subTotal, "money")}
                            </div>
                        </ListItem>
