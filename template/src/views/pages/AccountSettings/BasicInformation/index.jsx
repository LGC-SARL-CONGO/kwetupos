...
export default function BasicInformation({ onChange }) {
    return  <div className='account-settings-container__basic-information'>
        <Container className='mt-4'>
            <ContainerItem className='account-settings-container__basic-information--picture' sm={4} md={4} xl={12}>
                <div className='account-settings-container__basic-information--picture--avatar'>
                    <Avatar src={userImg} name='Beatriz' appearance='circle' size='xlarge' selection/>
                </div>
            </ContainerItem>
