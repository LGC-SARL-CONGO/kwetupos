                ...
                <TabContent>
                    <div className="mt-3">
                        <ComponentInfo title='Default'>
                            <Description>
                                <p>By default, the dropdown will align to the left and below the trigger.</p>
                            </Description>
                    ...
                    <div className="mt-3">
                        <ComponentInfo title='Placement'>
                            <Description>
                                <p>Sets the direction and alignment of the container in relation to the trigger.</p>
                            </Description>
                    ...
                    <div className="mt-3">
                        <ComponentInfo title='With icon'>
                            <Description>
                                <p>The dropdown component also accepts icons to be triggers.</p>
                            </Description>
                    ...
                    <div className="mt-3">
                        <ComponentInfo title='With elements'>
                            <Description>
                                <p>In addition to using icons to trigger the dropdowns, it's also possible to use HTML elements.</p>
                            </Description>
