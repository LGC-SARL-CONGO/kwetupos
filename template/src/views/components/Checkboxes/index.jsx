                ...
                <TabContent>
                    ...
                    <div className="mt-3">
                        <ComponentInfo title='Indeterminate'>
                            <Description>
                                <p>The indeterminate state is a special condition signaling that the checkbox is in an intermediate state, neither fully checked nor fully unchecked.</p>
                            </Description>
                    ...
                    <div className="mt-3">
                        <ComponentInfo title='Invalid'>
                            <Description>
                                <p>Displays an indication that the element has not been selected.</p>
                            </Description>
