...
export default function Toasts() {
    ...
    return (
        <AppPage title="Toast">
                ...
                <TabContent>
                    <div className="mt-3">
                        <ComponentInfo title='Default'>
                            ...
                            <Preview>
                               <Button appearance="primary" onClick={addToast}>Add toast</Button>
                            </Preview>
                    ...
                    <div className="mt-3">
                        <ComponentInfo title='Warning'>
                            <Preview>
                               <Button appearance="primary" onClick={() => addToastWithAppearance('warning')}>Add toast</Button>
                            </Preview>
                    ...
                    <div className="mt-3">
                        <ComponentInfo title='Danger'>
                            <Preview>
                               <Button appearance="primary" onClick={() => addToastWithAppearance('danger')}>Add toast</Button>
                            </Preview>
                    ...
                    <div className="mt-3">
                        <ComponentInfo title='Information'>
                            <Preview>
                               <Button appearance="primary" onClick={() => addToastWithAppearance('info')}>Add toast</Button>
                            </Preview>
                    ...
                    <div className="mt-3">
                        <ComponentInfo title='Success'>
                            <Preview>
                               <Button appearance="primary" onClick={() => addToastWithAppearance('success')}>Add toast</Button>
                            </Preview>
                    ...
                    <div className="mt-3">
                        <ComponentInfo title='Link'>
                            <Preview>
                               <Button appearance="primary" onClick={() => addToastWithAppearance('link')}>Add toast</Button>
                            </Preview>
                    ...
                    <div className="mt-3">
                        <ComponentInfo title='Auto dismiss'>
                            <Description>
                                <p>Using this property allows toasts to automatically destroy themselves after 8s.</p>
                            </Description>

                            <Preview>
                               <Button appearance="primary" onClick={addToastAutoDismiss}>Add toast</Button>
                            </Preview>
           ...
           {toasts?.filter(toast => !toast.appearance)?.length > 0 && <ToastContainer onDismiss={removeToast}>
                {toasts?.filter(toast => !toast.appearance)?.map(toast => (
                    <Toast 
                        {...toast}
                    />
                ))}
           ...
           {toasts?.filter(toast => ['warning', 'info', 'link']?.includes(toast.appearance))?.length > 0 && <ToastContainer>
                {toasts?.filter(toast => ['warning', 'info', 'link']?.includes(toast.appearance))?.map(toast => (
                    <Toast 
                        {...toast}
                        actions={[
                            {content: 'Subscribe', onClick: removeToast},
           ...
           {toasts?.filter(toast => ['danger', 'success']?.includes(toast.appearance))?.length > 0 && <ToastContainer>
                {toasts?.filter(toast => ['danger', 'success']?.includes(toast.appearance))?.map(toast => (
                    <Toast 
                        {...toast}
                        actions={[
                            {content: toast.appearance === 'danger' ? 'Try again' : 'Start task', onClick: removeToast},
                        ]}
                    />
                ))}
            </ToastContainer>}

           {toastsAutoDismiss?.length > 0 && <ToastContainer autoDismiss onDismissed={removeToastAutoDismiss}>
                {toastsAutoDismiss?.map(toast => (
                    <Toast 
                        {...toast}
                    />
                ))}
