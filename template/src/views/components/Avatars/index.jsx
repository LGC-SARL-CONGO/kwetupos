                    ...
                    <TabContent>
                        <div className="mt-3">
                            <ComponentInfo title='Default'>
                                <Description>
                                    <p>When no image or name is provided, the avatar component will display a default image.</p>
                                </Description>
                            ...
                            <ComponentInfo title='Simple'>
                                <Description>
                                    <p>By providing an image and name, if the image fails to load, the initials of the name will be displayed as a fallback.</p>
                                </Description>
