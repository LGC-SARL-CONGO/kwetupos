                ...
                <TabContent>
                    ...
                    <div className="mt-3">
                        <ComponentInfo title='Max Label Length'>
                            <Description>
                                <p>Used to truncate long labels. When activated, the full label name will be displayed as a tooltip. Labels have a maximum width of 250px, after which automatic truncation occurs.</p>
                            </Description>
