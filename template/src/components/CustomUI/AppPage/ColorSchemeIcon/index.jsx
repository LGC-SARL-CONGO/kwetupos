...
export default function ColorSchemeIcon({ menu, sidebar, background, checked, onClick }) {
    return (
        <svg width="110" height="70" xmlns="http://www.w3.org/2000/svg" onClick={onClick}>
            <rect x="0" y="0" width="110" height="70" fill="#eef2f7"/>
            <rect x="0" y="0" width="35" height="70" fill={sidebar || '#eef2f7'} stroke="#dee2e6" strokeWidth="1"/>
            ...
            {checked && (
                <>
                    ...
                    <path d="M92 55 l2 2 l4 -4" stroke="#ffffff" strokeWidth="2" fill="none" />
                </>
            )}
        </svg>
    );
